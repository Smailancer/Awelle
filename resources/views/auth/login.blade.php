<x-guest-layout>
    ...
    @if(session('info'))
        ...
        <div id="alert-border-4" class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-500 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800" role="alert">
